...
A lightweight and practical peer-to-peer file sharing application for local networks. It allows devices to discover each other over a LAN, exchange file information, and automatically synchronize shared files using only Python's standard library.
